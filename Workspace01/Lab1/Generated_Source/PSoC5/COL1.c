...
*
* \funcusage
*  \snippet COL1_SUT.c usage_COL1_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet COL1_SUT.c usage_COL1_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet COL1_SUT.c usage_COL1_Read  
*******************************************************************************/
...
* preferred COL1_Read() API because the 
* COL1_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet COL1_SUT.c usage_COL1_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: COL1_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use COL1_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - COL1_0_INTR       (First pin in the list)
    *  - COL1_1_INTR       (Second pin in the list)
    *  - ...
    *  - COL1_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet COL1_SUT.c usage_COL1_SetInterruptMode
    *******************************************************************************/
    void COL1_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & COL1_0_INTR) != 0u) 
		{ 
			 COL1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet COL1_SUT.c usage_COL1_ClearInterrupt
    *******************************************************************************/
