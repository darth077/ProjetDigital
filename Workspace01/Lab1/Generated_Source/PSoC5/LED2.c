...
*
* \funcusage
*  \snippet LED2_SUT.c usage_LED2_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet LED2_SUT.c usage_LED2_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet LED2_SUT.c usage_LED2_Read  
*******************************************************************************/
...
* preferred LED2_Read() API because the 
* LED2_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet LED2_SUT.c usage_LED2_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: LED2_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use LED2_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - LED2_0_INTR       (First pin in the list)
    *  - LED2_1_INTR       (Second pin in the list)
    *  - ...
    *  - LED2_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet LED2_SUT.c usage_LED2_SetInterruptMode
    *******************************************************************************/
    void LED2_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & LED2_0_INTR) != 0u) 
		{ 
			 LED2_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet LED2_SUT.c usage_LED2_ClearInterrupt
    *******************************************************************************/
